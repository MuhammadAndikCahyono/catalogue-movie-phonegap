...
function nowPlaying() {
  var nowPlayUrl = `https://api.themoviedb.org/3/movie/now_playing?api_key=1b5a89777c6756b303be04b2a6278801&language=en-US`;
  $.ajax({
    url: nowPlayUrl,
    method: 'GET',
    dataType: 'JSONP',
...
function upcoming() {
  var nowPlayUrl = `https://api.themoviedb.org/3/movie/upcoming?api_key=1b5a89777c6756b303be04b2a6278801&language=en-US`;
  $.ajax({
    url: nowPlayUrl,
    method: 'GET',
    dataType: 'JSONP',
